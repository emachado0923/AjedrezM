...
if (navigator.onLine) {
    ...
    document.querySelector('#OnlineLevel2').innerHTML =
        ...
        <p class="m-0 text-center"style="background-color:white !important;border-radius:10px ;width:80px"><i class="fa fa-star" style="color: #e0874b;"></i><strong class="m-0 ml-1" style="color:#254053">122</strong></p>
     </div>`;

    // Si no hay internet me va a generar un cuadro de Offline con un círculo rojo
} else {
    Online.className = 'onlineCont2 mainButton p-2 d-flex justify-content-center align-items-center flex-row';
...
window.addEventListener('online', function() {
    ...
    document.querySelector('#OnlineLevel2').innerHTML =
        `<div class="mainButton d-flex justify-content-center align-items-center pr-1 pl-1" style="margin-left: -20px; margin-top: 50px; border-width: 3px !important;">
        <p class="m-0 w-50 text-center"style="background-color:white !important;border-radius:10px ;width:80px"><i class="fa fa-star" style="color: #e0874b;"></i><strong class="m-0 ml-1" style="color:#254053">122</strong></p>
    </div>`;
