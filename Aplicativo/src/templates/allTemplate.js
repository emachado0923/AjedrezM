...
let titlebar = new customTitlebar.Titlebar({
    backgroundColor: customTitlebar.Color.fromHex('#0B1420'),
...
if(navigator.onLine){
    ...
    Online.innerHTML = '<div class="mr-2 onlineBall" style="width:10px; height:10px; border-radius:100%"></div>';
