...
function recibimos() {
    ...
    const colorBack1 = document.getElementById('colorBack1');
    colorBack1.style.background = localStorage.getItem('Back1');

    const back1 = document.getElementById('back1');
    back1.value = localStorage.getItem('Back1');
}



guardar = new Array();
guardar[0] = document.getElementById('back1');
guardar[1] = document.getElementById('colorBack1');
guardar[0].onchange = () => {
    const cambio = guardar[1].style.background = guardar[0].value;
    localStorage.setItem('Back1', cambio);
};
