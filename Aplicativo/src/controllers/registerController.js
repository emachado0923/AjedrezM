...
ipcRenderer.on('registroPersonas', () => {
    ...
    setTimeout(() => {
        window.location.href = './../views/testUsuario.html';
    }, 2000);
            ...
            function apagaPulsador(pulsador) {
                ...
                if (indSec == secuencia.length) { // Si ya no queda secuencia, Nivel superado
                    ...
                    if (cantidadSecuencias === 3) {
                        ...
                        aparato.style.cursor = 'inherit';
                        $('#test4Buttons').append(`
                            <button class="mainButton pr-3 pl-3 pt-2 pb-2 hvr-icon-rotate hvr-float d-flex align-items-center text-black" onclick="checkTestsInformation()"><i class="fa fa-list hvr-icon mr-2" style="font-size: 1.5em;"></i>Ver Estadísticas</button>
                        `);
