// Todo esto lo creamos para el correcto funcionanmiento de la animación del logo (SE COMENTO POR CARGA DE CODIGO)
/*
var loco = true;
	...
	if (emptyTable) {
		...
		for (var i = 0; i < validOption.length; i++) {
			if (x == validOption[i]) {
				...
				if (square.style.backgroundColor == "var(--black)") {
