...
$(document).ready(() => {
    ...
    $('#level1').click(() => {
        ...
        Swal.fire({
        html: `
        <div class="w-100 cont d-flex justify-content-center align-items-center flex-column" style="color: #254053;">
        ...
        var check = setTimeout(() => {
            ...
            <div class="mainButton mt-2 p-2 d-flex justify-content-center flex-column align-items-center w-100" style="background: white !important;">
                <div class="w-100 d-flex justify-content-center align-items-center" style="background: white; height: 100px; overflow: hidden; border-radius: 25px !important; box-shadow: 0 0 10px 1px rgba(0,0,0,0.2);">
                    <img src="./../../../assets/angles/vectors.png" class="w-100">
                </div>
                <p class="m-0 text-center mt-2" style='font-size: 15px;color:#254053'>
