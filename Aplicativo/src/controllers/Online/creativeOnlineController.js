...
$(document).ready(() => {
    ...
    $('#level1').click(() => {
        ...
        var check = setTimeout(() => {
            ...
            <div class="mainButton mt-2 p-2 d-flex justify-content-center flex-column align-items-center w-100" style="background: white !important; color:#254053 !important;font-size:20px">
