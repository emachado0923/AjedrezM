	...
	if (emptyTable) {
		...
		for (var i = 0; i < validOption.length; i++) {
			if (x == validOption[i]) {
				...
				if (document.getElementById("elem" + piece).style.backgroundColor == null) {
				...
				if (document.getElementById(validOption[i]).style.backgroundColor == null) {
					document.getElementById(validOption[i]).style.backgroundColor = null;
				}
...
function SearchOption() {
	...
	if (tdRow + 2 < 8 && tdCol + 1 < 20) //hard coded option 1
	{
		...
		if (document.getElementById(elem).style.backgroundColor != "var(--warning)" &&
			...
			if (document.getElementById(elem).style.backgroundColor == null) {
				document.getElementById(elem).style.backgroundColor = null;
			}
	...
	if (tdRow + 2 < 20 && tdCol - 1 >= 0) //hard coded option 2
	{
		var elem = "elem" + (tdRow + 2) + (tdCol - 1);
		if (document.getElementById(elem).style.backgroundColor != "var(--warning)" &&
			document.getElementById(elem).style.backgroundColor != "var(--info)") {
	...
	if (tdRow + 1 < 20 && tdCol + 2 < 20) //hard coded option 3
	{
	...
	if (tdRow - 1 >= 0 && tdCol + 2 < 20) //hard coded option 4
	{
		var elem = "elem" + (tdRow - 1) + (tdCol + 2);
		if (document.getElementById(elem).style.backgroundColor != "var(--warning)" &&
			document.getElementById(elem).style.backgroundColor != "var(--info)") {
	...
	if (tdRow + 1 < 20 && tdCol - 2 >= 0) //hard coded option 5
	{
		var elem = "elem" + (tdRow + 1) + (tdCol - 2);
		if (document.getElementById(elem).style.backgroundColor != "var(--warning)" &&
			document.getElementById(elem).style.backgroundColor != "var(--info)") {
	...
	if (tdRow - 2 >= 0 && tdCol + 1 < 20) //hard coded option 7
	{
		var elem = "elem" + (tdRow - 2) + (tdCol + 1);
		if (document.getElementById(elem).style.backgroundColor != "var(--warning)" &&
			document.getElementById(elem).style.backgroundColor != "var(--info)") {
...
function getGameOverStatus() {
	for (var i = 0; i < 20; i++) {
		for (var j = 0; j < 20; j++) {
			if (document.getElementById("elem" + i + j).style.backgroundColor == null ||
	...
	for (var i = 0; i < 20; i++) {
		for (var j = 0; j < 20; j++) {
			if (document.getElementById("elem" + i + j).style.backgroundColor == "var(--warning)" ||
				document.getElementById("elem" + i + j).style.backgroundColor == null) {
				document.getElementById("elem" + i + j).style.backgroundColor = null;
			}
