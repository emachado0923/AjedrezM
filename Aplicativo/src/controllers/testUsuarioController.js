...
function formsInit() {
    ...
    var iconos = [
        `src="../../assets/figuras/triangulo_amarillo1.png"`,
        `src="../../assets/figuras/triangulo_azul1.png"`,
        `src="../../assets/figuras/triangulo_naranja1.png"`,
        `src="../../assets/figuras/triangulo_rojo1.png"`,
        `src="../../assets/figuras/triangulo_verde1.png"`,
        `src="../../assets/figuras/triangulo_naranja2.png"`,
        `src="../../assets/figuras/triangulo_verde2.png"`,
        `src="../../assets/figuras/triangulo_rojo2.png"`,
        `src="../../assets/figuras/triangulo_azul2.png"`,
        `src="../../assets/figuras/triangulo_amarillo2.png"`
    ];
    ...
    droppableElements[0].innerHTML = `<span class='timeIcons' style="font-size: 1em; display:none;"><img style="width: 100%" ${iconos[posRandom1]}></span>
    ...
    droppableElements[1].innerHTML = `<span class='timeIcons' style="font-size: 1em; display:none;"><img style="width: 100%"${iconos[posRandom2]}></span>
    <i class='locked fa fa-close d-none' style='font-size: 1em; color: #7b2921;'></i>
    <i class='check fa fa-check d-none' style='font-size: 1em; color: #0a735f;'></i>`;
...
function drop(e) {
    ...
    if (draggableElementData === droppableElementData) {
        ...
        e.target.innerHTML = `<img style="width: 100%"${draggableElementData}></img>`;
        ...
        if (points === 2) {
            ...
            $('#number2').removeClass('color_azul text-white');
            ...
            $('#test1Buttons').append(`
                <button class="mainButton pr-3 pl-3 pt-2 pb-2 hvr-icon-rotate hvr-float d-flex align-items-center siguiente_test" data-target="#tests" data-slide-to="2" onclick="test2ModalOpen()"style="border-radius:30px !important"><i class="fa fa-arrow-circle-right hvr-icon mr-2" style="font-size: 1.5em;border-radius:30px !important"></i>Siguiente Test</button>
            `);
            ...
            Swal.fire({
                ...
                html: "Has completado este <strong>Test</strong>.<br> <strong>El <span class='text-black'>Test 2</span> ahora está disponible! <i class='text-black fa fa-arrow-circle-right'></i></strong>",
                icon: 'success',
...
function formsInitA() {
    ...
    // Luego añadimos dos íconos que nos servirán cuando el test aún no inicie donde estará una equix y el otro es cuando se rellenen los cuadros satisfactoriamente que sería un check de correcto
    // y por último le damos al atributo data-draggable-id el nombre del ícono que se genere automáticamente
    droppableElementsA[0].innerHTML = `<span class='timeIconsA' style="font-size: 1em; display:none;"><img style="width: 100%" ${iconosA[posRandom1A]}></span>
    ...
    // aquí se hace lo mismo que en el cuadro 1, sólo que al "droppableElements[]" se le colca la posición [1]
    droppableElementsA[1].innerHTML = `<span class='timeIconsA' style="font-size: 1em; display:none;"><img style="width: 100%" ${iconosA[posRandom2A]}></span>
    <i class='lockedA fa fa-close d-none' style='font-size: 1em; color: #7b2921;'></i>
    <i class='checkA fa fa-check d-none' style='font-size: 1em; color: #0a735f;'></i>`;
    ...
    droppableElementsA[2].innerHTML = `<span class='timeIconsA' style="font-size: 1em; display:none;"><img style="width: 100%" ${iconosA[posRandom3A]}></span>
    <i class='lockedA fa fa-close d-none' style='font-size: 1em; color: #7b2921;'></i>
    <i class='checkA fa fa-check d-none' style='font-size: 1em; color: #0a735f;'></i>`;
...
function dropA(e) {
    ...
    if (draggableElementDataA === droppableElementDataA) {
        ...
        // aquí le estamos colocando el ícono que arrastramos dentro del cuadro
        e.target.innerHTML = `<img style="width: 100%"${draggableElementDataA}></img>`;
        ...
        if (pointsA === 3) {
            ...
            $('#number3').removeClass('color_azul');
            ...
            $('#number4').removeClass('color_azul text-white');
            // aquí le decimos que cuando presione el número "3" abra las instrucciones del test 3
            $('#number4').click(() => {
                test4ModalOpen();
            });
            ...
            $('#test2Buttons').append(`
                <button class="mainButton pr-3 pl-3 pt-2 pb-2 hvr-icon-rotate hvr-float d-flex align-items-center siguiente_test" data-target="#tests" data-slide-to="3" onclick="test3ModalOpen()"style="border-radius:30px !important"><i class="fa fa-arrow-circle-right hvr-icon mr-2" style="font-size: 1.5em;"></i>Siguiente Test</button>
            `);
            ...
            Swal.fire({
                title: 'Test Completado',
                html: "Has completado este <strong>Test</strong>.<br> <strong>El <span class='text-black'>Test 3</span> y <span class='text-black'>Test 4</span> ahora están disponibles! <i class='text-success fa fa-arrow-circle-right'></i></strong>",
                icon: 'success',
                showCloseButton: true,
                showCancelButton: false,
                showConfirmButton: false,
...
function formsInitB() {
    ...
    droppableElementsB[0].innerHTML = `<span class='timeIconsB' style="font-size: 1em; display:none;"><img style="width:100%"${iconosB[posRandom1B]}></span>              
    ...
    // aquí se hace lo mismo que en el cuadro 1, sólo que al "droppableElements[]" se le colca la posición [1]
    droppableElementsB[1].innerHTML = `<span class='timeIconsB' style="font-size: 1em; display:none;"><img style="width:100%"${iconosB[posRandom2B]}></span>
    <i class='lockedB fa fa-close d-none' style='font-size: 1em; color: #7b2921;'></i>
    <i class='checkB fa fa-check d-none' style='font-size: 1em; color: #0a735f;'></i>`;
    droppableElementsB[1].setAttribute('data-draggable-id', iconosB[posRandom2B]);

    // aquí se hace lo mismo que en el cuadro 1, sólo que al "droppableElements[]" se le colca la posición [2]
    droppableElementsB[2].innerHTML = `<span class='timeIconsB' style="font-size: 1em; display:none;"><img style="width:100%"${iconosB[posRandom3B]}></span>
    <i class='lockedB fa fa-close d-none' style='font-size: 1em; color: #7b2921;'></i>
    <i class='checkB fa fa-check d-none' style='font-size: 1em; color: #0a735f;'></i>`;
    ...
    droppableElementsB[3].innerHTML = `<span class='timeIconsB' style="font-size: 1em; display:none;"><img style="width:100%"${iconosB[posRandom4B]}></span>
    <i class='lockedB fa fa-close d-none' style='font-size: 1em; color: #7b2921;'></i>
    <i class='checkB fa fa-check d-none' style='font-size: 1em; color: #0a735f;'></i>`;
...
function dropB(e) {
    ...
    if (draggableElementDataB === droppableElementDataB) {
        ...
        // aquí le estamos colocando el ícono que arrastramos dentro del cuadro
        e.target.innerHTML = `<img style="width: 100%"${draggableElementDataB}></img>`;
        ...
        if (pointsB === 4) {
            ...
            Swal.fire({
                title: 'Test Completado',
                html: "Has completado este <strong>Test</strong>.<br> <strong>Tienes grandes Habilidades Cognitivas, <span class='text-black'>Felicitaciones! <i class='text-warning fa fa-star'></i></span></strong>",
                icon: 'success',
                showCloseButton: true,
                showCancelButton: false,
                showConfirmButton: false,
        ...
        function compruebaPulsacion(ev) {
            ...
            if (pulsador.id != 'aparato') {
                if (pulsador.id === secuencia[indSec]) { // Si se pulsa el pulsador correcto...
                    ...
                    salida.innerHTML = 'PERDISTE!. Haz clic en <span style="color:white><i class="fa fa-play"></i> Comenzar</span> para volver a jugar';
            ...
            function apagaPulsador(pulsador) {
                ...
                if (indSec == secuencia.length) { // Si ya no queda secuencia, Nivel superado
                    ...
                    if (nivel === 5) {
                        ...
                        $('#secuencAnim').attr('style', 'color:white;');
                        setTimeout(() => {
                            reseteaAparato();
                            aniadeColorSecuencia();
                    ...
                    if (cantidadSecuencias === 3) {
                        ...
                        aparato.style.cursor = 'inherit';
                        $('#test4Buttons').append(`
                            <button class="mainButton pr-3 pl-3 pt-2 pb-2 hvr-icon-rotate hvr-float d-flex align-items-center" onclick="checkTestsInformation()"><i class="fa fa-list hvr-icon mr-2" style="font-size: 1.5em;color:#254053 !important;border-radius: 30px !important"></i>Ver Estadísticas</button>
                        `);
                        ...
                        Swal.fire({
                            title: 'Test Completado',
                            html: "Has completado los diferentes <strong>Tests</strong> Satisfactoriamente!<br> Ahora puedes pasar a jugar <strong><span class='text-black'>Ajedrez M!</span><br><h4><strong>Bienvenido a esta aventura!</strong></h4> <i class='text-black fa fa-sign-out' style='font-size:2em;'></i></strong>",
                            icon: 'success',
                            showCloseButton: true,
                            showCancelButton: false,
                            showConfirmButton: false,
