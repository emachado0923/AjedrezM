...
const offlineIcon = document.querySelector('#offlineIcon');
const onlineIcon = document.querySelector('#onlineIcon');
...
if (navigator.onLine) {
    ...
    document.querySelector('#OnlineLevel').innerHTML =
        `<div class=" w-50 d-flex justify-content-center align-items-center pr-1 pl-1" style="border-width: 3px !important;">
        <p class="m-0 w-25 text-center"style="background-color:white !important;border-radius:10px ;"><i class="fa fa-star" style="color: #e0874b;"></i><strong class="m-0 ml-1" style="color:#254053">122</strong></p>
    </div>`;
